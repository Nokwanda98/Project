        ...
        <div className="mt-6 sm:mt-8 lg:mt-0">
          ...
          <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
            ...
            <a
              href="#"
              title=""
              className="text-white mt-4 sm:mt-0 bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-orange-600 dark:hover:bg-orange-700 focus:outline-none dark:focus:ring-orange-800 flex items-center justify-center"
              role="button"
            >
              <svg
                className="w-5 h-5 -ms-2 me-2"
